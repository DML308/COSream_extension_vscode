...
function insertLuaKeywordText(word) {
...
function insertXMakeCommandText(func) {
    return func + '(${1})'
}

// get suggestions
function getSuggestions(cmdlist, currentWord, kind, insertText, matchPredicate) {
...
function getLuaKeywordsSuggestions(word){
...
function getXMakeCommandsSuggestions(word) {
...
export function activate(ctx) {
    ...
    ctx.subscriptions.push(
        vscode.languages.registerCompletionItemProvider(
            {scheme:'file',language:'costream'}, new Completion());
    ...
}